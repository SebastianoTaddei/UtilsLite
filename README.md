...
Fork of [UtilsLite](https://github.com/ebertolazzi/UtilsLite) by Enrico Bertolazzi.
...
```bash
git clone --branch stable --depth 1 https://github.com/SebastianoTaddei/UtilsLite.git
cd UtilsLite
ruby setup.rb
rake
```
